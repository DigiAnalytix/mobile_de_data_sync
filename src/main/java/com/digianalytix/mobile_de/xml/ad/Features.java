 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://services.mobile.de/schema/ad}feature" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends ResourceDataType
{
    ...
    protected List<ResourceDataType> feature;
     ...
     * 
     */
    public List<ResourceDataType> getFeature() {
        if (feature == null) {
            feature = new ArrayList<ResourceDataType>();
        }
        return this.feature;
    }
